...
<body>
    <header>
        ...
        <h2><a href="account_info.php">계정정보</a></h2>
        <h2><a href="genre.php">장르선택</a></h2>
    </header>
    ...
    <main>
        ...
        ?>
            <a href="content.php?genre=<?= htmlspecialchars($item['genre']) ?>" class="<?= htmlspecialchars($item['genre']) ?>" <?= !$isVisible ? "style='visibility: hidden;'" : "" ?>>
